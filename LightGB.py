...
from lightgbm import LGBMRegressor # Changed from xgboost to lightgbm
import joblib

# Paths
csv_path = r'C:\Users\lando\Desktop\AI\8090challenge\public_caseswithfeatures.csv'
# Updated model path to reflect the LGBM model
model_path_full = r'C:\Users\lando\Desktop\AI\8090challenge\lgbm_reimbursement_modelwithfeatures.joblib' 
...
for i in range(n_splits):
    ...
    # Changed model initialization to LGBMRegressor
...
# Changed final model initialization to LGBMRegressor
final_model = LGBMRegressor(random_state=base_seed) 
final_model.fit(X, y)
